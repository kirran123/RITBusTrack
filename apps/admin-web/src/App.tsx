      ...
      try {
        ...
        channel.send({
          ...
          payload: {
            ...
            message,
            busId,
            busNumber: targetBus?.bus_number || 'BUS 12',
      ...
      try {
        ...
        channel.send({
          ...
          payload: {
            ...
            message,
            busId: newBusId,
            busNumber: newBus?.bus_number || 'BUS 15',
            originalBusNumber: oldBus?.bus_number || 'BUS 12',
            replacementBusNumber: newBus?.bus_number || 'BUS 15',
