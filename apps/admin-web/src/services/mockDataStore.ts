...
export const INITIAL_STAFF: StaffUser[] = [
  {
    ...
    name: 'Mr. N. Govindaraju',
    email: 'govindaraju.transport@ritrjpm.ac.in',
    phone: '+91 96292 84690',
    password: 'staff123',
    department: 'Transport Department',
    designation: 'Transport Incharge',
    access_level: 'edit',
    assigned_route_ids: ['r1', 'r2', 'r3', 'r4', 'r5', 'r6', 'r7', 'r8', 'r9', 'r10', 'r11', 'r12', 'r13', 'r14', 'r15', 'r16', 'r17', 'r18', 'r19', 'r20', 'r21', 'r22', 'r23', 'r24', 'r25', 'r26', 'r27', 'r28', 'r29', 'r30'],
    status: 'active',
  ...
  },
  {
    ...
    phone: '+91 97155 40479',
    password: 'staff123',
    department: 'Mechanical Engineering',
    designation: 'AP/Mech & Transport Coordinator',
    access_level: 'edit',
    assigned_route_ids: ['r1', 'r2', 'r3', 'r4', 'r5', 'r6', 'r7', 'r8', 'r9', 'r10'],
    status: 'active',
